// global: d3
// @preserve Copyright © 2015, Olaf Frohn. Released under BSD license, see LICENSE
function $(t){return document.getElementById(t)}var settings={width:1024,// Default width; height is determined by projection
...
stars:{show:!0,// Show stars
limit:6,// down to maximum stellar magnitude
colors:!0,// Show stars in spectral colors, if not use "color"
color:"#fff",// Default color for stars
names:!0,// Show star names (css-class starname)
proper:!1,// Show proper names (if none shows designation)
desig:!0,// Show designation (Bayer, Flamsteed, Variable star, Gliese, Draper, Hipparcos, whichever applies first)
namelimit:2,// Maximum magnitude with name
data:"data/stars.6.json"},dsos:{show:!0,// Show Deep Space Objects (css-class per type)
limit:6,// down to maximum magnitude
names:!0,// Show DSO names
desig:!0,// Show short DSO names
namelimit:4,// Maximum magnitude with name
data:"data/dsos.bright.json"},constellations:{show:!0,// Show constellations 
names:!0,// Show constellation names (css-class: constname)
desig:!0,// Show short constellation names (3 letter designations)
lines:!0,// Show constellation lines (css-class: constline)
bounds:!1},mw:{show:!0},lines:{graticule:!0,// Show graticule lines (css-class: gridline)
equatorial:!1,// Show equatorial plane (css-class: equatorial)
ecliptic:!0,// Show ecliptic plane (css-class: ecliptic)
galactic:!1,// Show galactic plane (css-class: galactic)
supergalactic:!1},set:function(t){// Override defaults with values of cfg
var e,a,r={};if(!t)return this;for(e in this)if(this.hasOwnProperty(e)&&"function"!=typeof this[e])if(t.hasOwnProperty(e)&&null!==t[e])if(this[e].constructor!=Object)r[e]=t[e];else{r[e]={};for(a in this[e])r[e][a]=t[e].hasOwnProperty(a)?t[e][a]:this[e][a]}else r[e]=this[e];return r}},symbols={gg:{shape:"circle",stroke:"#f00",fill:"#f00"},// Galaxy cluster red circle
