...
target.build = function() {
  ...
  */
  ...
  tar.pack('./', {
       entries: ['viewer.html', 'map.html', 'sky.html', 'celestial.css', 'readme.md', 'LICENSE', 'celestial.min.js', 'celestial.js', 'dtpick.png', 'data', 'lib/d3.min.js', 'lib/d3.geo.projection.min.js'] 
     })
